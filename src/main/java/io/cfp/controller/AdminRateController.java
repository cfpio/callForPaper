...
public class AdminRateController {
     ...
     * Edit a rating
     */
    @RequestMapping(value = "/api/rates/{rateId}", method=RequestMethod.PUT)
    @Secured({Role.REVIEWER, Role.ADMIN})
     ...
     */
    @RequestMapping(value = "/api/rates/{rateId}", method= RequestMethod.GET)
    @Secured(Role.ADMIN)
     ...
     * @return
     */
    @RequestMapping(value = "/api/rates/user/{userId}", method= RequestMethod.GET)
    @Secured(Role.ADMIN)
     ...
     */
    @RequestMapping(value = "/api/rates/proposals/{talkId}", method= RequestMethod.GET)
    @Secured(Role.ADMIN)
     ...
     */
    @RequestMapping(value = "/api/rates/proposals/{talkId}/me", method = RequestMethod.GET)
    @Secured({Role.REVIEWER, Role.ADMIN})
