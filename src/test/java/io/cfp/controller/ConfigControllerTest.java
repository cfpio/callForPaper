...
@WebMvcTest(io.cfp.controller.ConfigController.class)
@Deprecated
public class ConfigControllerTest {
    ...
    public void should_open_cfp() throws Exception {
        ...
        mockMvc.perform(post("/v0/config/enableSubmissions")
        ...
        ;
         ...
         verify(applicationConfigService).openCfp();
    }
    ...
    public void should_close_cfp() throws Exception {
        ...
        verify(applicationConfigService).closeCfp();
    }
}
